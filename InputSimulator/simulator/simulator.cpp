...
#include <stdio.h>
#include <stdlib.h>
Simulator::Simulator(SimulateKey* simulateKey, SimulateMouse* simulateMouse, Console* console) : mSimulateKey(simulateKey), mSimulateMouse(simulateMouse), mConsole(console)
{
