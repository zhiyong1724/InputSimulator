...
#include <stdlib.h>
#include <chrono>
Simulator::Simulator(SimulateKey* simulateKey, SimulateMouse* simulateMouse, Console* console) : mSimulateKey(simulateKey), mSimulateMouse(simulateMouse), mConsole(console), mIsReady(false)
{
